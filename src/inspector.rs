...
extern "C" {
  fn v8_inspector__V8Inspector__Channel__BASE__CONSTRUCT(
    buf: &mut core::mem::MaybeUninit<Channel>,
  );
  ...
  fn v8_inspector__V8InspectorClient__BASE__CONSTRUCT(
    buf: &mut core::mem::MaybeUninit<V8InspectorClient>,
  );
...
impl ChannelBase {
  fn construct_cxx_base() -> Channel {
    unsafe {
      let mut buf = core::mem::MaybeUninit::<Channel>::uninit();
  ...
  fn get_cxx_base_offset() -> FieldOffset<Channel> {
    let buf = core::mem::MaybeUninit::<Self>::uninit();
  ...
  where
    T: ChannelImpl,
  {
    let buf = core::mem::MaybeUninit::<T>::uninit();
  ...
  pub unsafe fn dispatch(channel: &Channel) -> &dyn ChannelImpl {
    ...
    core::mem::transmute((embedder, this.rust_vtable))
  }
  ...
  pub unsafe fn dispatch_mut(channel: &mut Channel) -> &mut dyn ChannelImpl {
    ...
    core::mem::transmute((embedder, vtable))
  }
}
...
impl V8InspectorClientBase {
  fn construct_cxx_base() -> V8InspectorClient {
    unsafe {
      let mut buf = core::mem::MaybeUninit::<V8InspectorClient>::uninit();
